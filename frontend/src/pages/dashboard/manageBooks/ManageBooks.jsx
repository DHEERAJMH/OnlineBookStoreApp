...
const ManageBooks = () => {
  ...
  const { data: response = {} } = useFetchAllBooksQuery(); // Ensure response defaults to an empty object
  const books = response.books || []; // Extract books array or default to an empty array
